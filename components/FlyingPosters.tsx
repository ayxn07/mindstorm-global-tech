...
class Canvas {
  ...
  setScrollImmediate(value: number) {
    this.scroll.target = value;
    this.scroll.current = value;
    this.scroll.last = value;
  }
...
interface FlyingPostersProps extends React.HTMLAttributes<HTMLDivElement> {
  ...
  cameraFov?: number;
  cameraZ?: number;
  onReady?: (handle: FlyingPostersHandle) => void;
}
...
export default function FlyingPosters({
  ...
  useEffect(() => {
    ...
    onReadyRef.current?.({
      setScroll: (value: number) => instance.setScrollTarget(value),
      setScrollImmediate: (value: number) => instance.setScrollImmediate(value),
    });
